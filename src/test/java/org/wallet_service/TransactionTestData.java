...
public class TransactionTestData {
    ...
    public static TransactionRequestDTO TRANSACTION_TO_1 = new TransactionRequestDTO(ID1.toString(), "CREDIT", "1000.00", "transaction #1", TOKEN);
    public static TransactionTO TRANSACTION_TO_2 = new TransactionTO(ID2, OperationType.DEBIT, "699.99", "transaction #2", TOKEN);
    public static TransactionTO TRANSACTION_TO_3 = new TransactionTO(ID3, OperationType.DEBIT, "300.01", "transaction #3", TOKEN);
    public static TransactionTO TRANSACTION_TO_4 = new TransactionTO(ID4, OperationType.DEBIT, "100.00", "transaction #4", TOKEN);
    public static TransactionTO TRANSACTION_TO_5 = new TransactionTO(ID5, OperationType.CREDIT, "444.44", "transaction #5", TOKEN);

    public static TransactionTO TRANSACTION_TO_WITH_EXPIRED_TOKEN = new TransactionTO(ID3, OperationType.DEBIT, "300.01", "transaction #3", EXPIRED_TOKEN);
